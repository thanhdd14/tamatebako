...
function montblanc_scripts()
{
    ...
    wp_enqueue_style('montblanc-slick', get_template_directory_uri() . '/css/slick.css', array(), 1.0);
    wp_enqueue_style('montblanc-slick-theme', get_template_directory_uri() . '/css/slick-theme.css', array(), 1.0);
    wp_enqueue_style('montblanc-swiper', get_template_directory_uri() . '/css/swiper.css', array(), 1.0);
    wp_enqueue_style('montblanc-oc', get_template_directory_uri() . '/css/oc-theme.css', array(), 1.0);

    wp_enqueue_script('montblanc-header', get_template_directory_uri() . '/js/header.js', array(), '1.0', true);

    wp_enqueue_script('montblanc-jquery', get_template_directory_uri() . '/js/jquery-3.3.1.min.js', array(), '1.0', true);
    wp_enqueue_script('montblanc-slick', get_template_directory_uri() . '/js/slick.min.js', array(), '1.0', true);
    wp_enqueue_script('montblanc-oc', get_template_directory_uri() . '/js/swiper.js', array(), '1.0', true);
    wp_enqueue_script('montblanc-jquery-matchHeight', get_template_directory_uri() . '/js/jquery.matchHeight-min.js', array(), '1.0', true);
    wp_enqueue_script('montblanc-slidecart', get_template_directory_uri() . '/js/slidecart.js', array(), '1.0', true);
    wp_enqueue_script('montblanc-oc', get_template_directory_uri() . '/js/oc-theme.js', array(), '1.0', true);
